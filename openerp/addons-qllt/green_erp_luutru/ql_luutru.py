...
class luu_tru(osv.osv):
    ...
    _columns = {
        ...
        'khach_tinhtp_id': fields.many2one( 'tinh.tp','Tỉnh/TP'),
        'khach_phuongxa_id': fields.many2one( 'phuong.xa','Phường (xã)'),
        'khach_quanhuyen_id': fields.many2one('quan.huyen','Quận (huyện)'),
        ...
        'quoc_tich_id': fields.many2one('quoc.tich','Quốc tịch', required = True),
